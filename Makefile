#############################################################################
# Makefile for building: SSHFileTransfer
# Generated by qmake (3.1) (Qt 6.2.4)
# Project:  SSHFileTransfer.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile SSHFileTransfer.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I. -I. -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SSHFileTransfer1.0.0
DISTDIR = /home/tom/all_devs/qtstuff/SSHFileTransfer/.tmp/SSHFileTransfer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -L/usr/lib/x86_64-linux-gnu -lssh2 /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Network.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp \
		...
		moc_mainwindow.cpp \
		moc_filetransferworker.cpp
OBJECTS       = main.o \
		filetransferworker.o \
		mainwindow.o \
		qrc_resources.o \
		moc_mainwindow.o \
		moc_filetransferworker.o
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		SSHFileTransfer.pro mainwindow.h \
		filetransferworker.h main.cpp \
		filetransferworker.cpp \
		mainwindow.cpp
QMAKE_TARGET  = SSHFileTransfer
DESTDIR       = 
...
SSHFileTransfer: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: SSHFileTransfer.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile SSHFileTransfer.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h filetransferworker.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp filetransferworker.cpp mainwindow.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_filetransferworker.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_filetransferworker.cpp
moc_mainwindow.cpp: mainwindow.h \
		ui_mainwindow.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/tom/all_devs/qtstuff/SSHFileTransfer/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/tom/all_devs/qtstuff/SSHFileTransfer -I/usr/include -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp

moc_filetransferworker.cpp: filetransferworker.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/tom/all_devs/qtstuff/SSHFileTransfer/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/tom/all_devs/qtstuff/SSHFileTransfer -I/usr/include -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtNetwork -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include filetransferworker.h -o moc_filetransferworker.cpp
...
filetransferworker.o: filetransferworker.cpp filetransferworker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o filetransferworker.o filetransferworker.cpp

mainwindow.o: mainwindow.cpp filetransferworker.h \
		mainwindow.h \
		ui_mainwindow.h
...
moc_filetransferworker.o: moc_filetransferworker.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_filetransferworker.o moc_filetransferworker.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/SSHFileTransfer/bin || mkdir -p $(INSTALL_ROOT)/opt/SSHFileTransfer/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/SSHFileTransfer/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/SSHFileTransfer/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/SSHFileTransfer/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/SSHFileTransfer/bin/ 
